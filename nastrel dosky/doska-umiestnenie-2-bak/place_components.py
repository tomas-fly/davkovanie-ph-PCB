...
DY = 44
PLACEMENT["P2"]   = (AX + 60, BY + 16 + DY, 0)  # BNC right side
...
# --- CONNECTORS (edges) ---
PLACEMENT["J2"]   = (AX + 72, BY + 48, 0)     # Display 1×14 (4×37mm) — right edge
PLACEMENT["J7"]   = (AX + 66, BY + 96, 0)     # GPIO 2×10 (6×26mm) — right side
PLACEMENT["J8"]   = (AX + 56, BY + 122, 0)    # UART 1×4 — bottom-right
