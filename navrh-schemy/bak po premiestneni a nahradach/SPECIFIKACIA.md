...
| U6 | CA3140AMZ | CMOS op-amp | DIP-8 | Zin >1TΩ, kritický pre pH sondu |
...
| U8 | CA3140AMZ | CMOS op-amp | DIP-8 | Vstupný buffer ORP |
...
| 3 | U3 | AMS1117-3.3 | 5V→3.3V/1A | 1 | LDO, SOT-223 |
| 4 | U4 | LM7805 | 12V→5V (lineárny) | 1 | TO-220, čistá analóg 5V |
| 5 | U5 | TPS60400DBVR | 5V→-5V/60mA | 1 | Charge pump, SOT-23-5 |
| 6 | U6, U8 | CA3140AMZ | CMOS op-amp | 2 | DIP-8, pH+ORP buffer |
| 7 | U7, U9 | TL081CDT | JFET op-amp | 2 | SOIC-8, pH+ORP výstup |
| 8 | U10 | ADS1115IDGSR | 16-bit ADC, I2C | 1 | MSOP-10 |
| 9 | U11 | ESP32-WROOM-32E-N4 | MCU modul | 1 | WiFi + BT, 4MB flash |
| 10 | U12 | PC817 | Optočlen | 1 | DIP-4, izolácia relé |
| 11 | Q1-Q4 | IRLZ44NPBF | N-MOSFET 55V/47A | 4 | TO-220, logic-level |
| 12 | RLY1 | Finder 40.52.9.012 | Relé 12V, 16A/250VAC | 1 | 2×prepínací kontakt |
| 13 | D1 | LED modrá | — | 1 | 0805 |
| 14 | D2 | SS34 | 40V/3A Schottky | 1 | SMA, buck dióda |
| 15 | D3-D6 | SS14 | 40V/1A Schottky | 4 | SOD-123, flyback MOSFET |
| 16 | D7 | 1N4007 | 1000V/1A | 1 | DO-41, flyback relé |
...
| 52 | P1, P2 | BNC konektor | Panel mount | 2 | pH + ORP sonda |
...
| 6 | U6, U8 | CA3140AMZ | [TME](https://www.tme.eu/en/details/ca3140amz/smd-operational-amplifiers/renesas-intersil/) | **SOIC-8** | Renesas, ⚠️ 0 ks na sklade! |
| 6b | U6, U8 alt. | CA3140MZ | [TME](https://www.tme.eu/en/details/ca3140mz/smd-operational-amplifiers/renesas-intersil/) | SOIC-8 | Bez "A" suffix, ⚠️ tiež 0 ks |
| 7 | U7, U9 | TL071IDT | [TME](https://www.tme.eu/en/details/tl071idt/smd-operational-amplifiers/stmicroelectronics/) | SOIC-8 | STMicro, JFET op-amp, pin-kompatibilný s TL081, nižší šum (over. dostupnosť!) |
| 7b | U7, U9 alt. | TL081CDT | [TME](https://www.tme.eu/en/details/tl081cdt/smd-operational-amplifiers/stmicroelectronics/) | SOIC-8 | ⚠️ 0 ks na sklade |
...
- **U6, U8 (CA3140AMZ):** SOIC-8 je správne SMD puzdro. **Problém: 0 ks na sklade TME!** CA3140MZ (bez "A") tiež 0 ks. Možné riešenia:
  - Objednať s čakaním na dodávku (TME ukáže termín)
  - Hľadať na Mouser/Farnell/DigiKey
  - Alternatíva: zvážiť iný CMOS op-amp s ultra-vysokým Zin (napr. OPA129, LMC6001) — ale zmení sa zapojenie!
...
- **U7, U9 (TL081):** TL081CDT má 0 ks na TME. Náhrada: **TL071IDT** — rovnaká rodina (TL07x), SOIC-8, pin-kompatibilný, dokonca nižší šum. Overiť dostupnosť na TME!
