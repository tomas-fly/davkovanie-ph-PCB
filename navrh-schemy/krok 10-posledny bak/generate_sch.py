...
# Standard 8-pin DIP op-amp (used for CA3140AMZ)
# Pin 1: Offset N1, Pin 2: IN-, Pin 3: IN+, Pin 4: V-
# Pin 5: Offset N2, Pin 6: OUT, Pin 7: V+, Pin 8: Strobe/NC
LIB_OPAMP_DIP8 = """(symbol "Custom:CA3140AMZ" (pin_names (offset 1.016))
    (exclude_from_sim no) (in_bom yes) (on_board yes)
    (property "Reference" "U" (at 0 7.62 0)
      (effects (font (size 1.27 1.27)))
    )
    (property "Value" "CA3140AMZ" (at 0 -7.62 0)
      (effects (font (size 1.27 1.27)))
    )
    (property "Footprint" "" (at 0 0 0)
      (effects (font (size 1.27 1.27)) (hide yes))
...
# TL081CDT SOIC-8 op-amp (same pinout as CA3140 but different package)
LIB_OPAMP_TL081 = """(symbol "Custom:TL081CDT" (pin_names (offset 1.016))
    (exclude_from_sim no) (in_bom yes) (on_board yes)
    (property "Reference" "U" (at 0 7.62 0)
      (effects (font (size 1.27 1.27)))
    )
    (property "Value" "TL081CDT" (at 0 -7.62 0)
      (effects (font (size 1.27 1.27)))
    )
    (property "Footprint" "" (at 0 0 0)
      (effects (font (size 1.27 1.27)) (hide yes))
    ...
    (property "Description" "JFET-Input Op-Amp, SOIC-8" (at 0 0 0)
      (effects (font (size 1.27 1.27)) (hide yes))
    )
    (symbol "TL081CDT_0_1"
      (polyline
...
def generate_step5():
    ...
    # R at 90°: pin1 at (r2_x-5.08, r2_y)=(216.92, 195), pin2 at (r2_x+5.08, r2_y)=(227.08, 195)

    # Wire BNC signal → R2 pin1
    wires.append(make_wire(213.81, p1_y, 216.92, p1_y))
    ...
    node_in_x = 230
    node_in_y = p1_y  # 195
    wires.append(make_wire(227.08, p1_y, node_in_x, node_in_y))
    ...
    symbols.append(make_symbol("Custom:CA3140AMZ", "U6", "CA3140AMZ",
    ...
    # R3 pin1 at (r3_x, r3_y-5.08), pin2 at (r3_x, r3_y+5.08)
    wires.append(make_wire(pin2_x, c14_y, r3_x, c14_y))
    wires.append(make_wire(r3_x, r3_y - 5.08, r3_x, c14_y))
    ...
    wires.append(make_wire(r3_x, r3_y + 5.08, r4_x, r4_y - 3.81))
    ...
    wires.append(make_wire(r4_x, r4_y + 3.81, r5_x, r5_y - 5.08))

    symbols.append(make_symbol("power:GND", "#PWR35", "GND",
                               r5_x, r5_y + 8, 0, pin_count=1))
    wires.append(make_wire(r5_x, r5_y + 5.08, r5_x, r5_y + 8))

    # Pot wiper (pin2) — connect to IN- path (already connected via R3)
    # Actually the wiper output is used for calibration offset, leave connected

    # ======== U7: TL081CDT (output stage, inverting amplifier) ========
    u7_x = 290
    u7_y = 190

    symbols.append(make_symbol("Custom:TL081CDT", "U7", "TL081CDT",
    ...
    # R7 at 90°: pin1 at (264.92, 192.54), pin2 at (275.08, 192.54)

    # Wire U6 OUT → R7 pin1
    wires.append(make_wire(out_node_x, out_node_y, out_node_x, r7_y))
    wires.append(make_wire(out_node_x, r7_y, 264.92, r7_y))

    # Wire R7 pin2 → U7 IN-
    wires.append(make_wire(275.08, r7_y, u7_pin2_x, u7_pin2_y))
    ...
    # R6 at 90°: pin1 at (r6_x-5.08, r6_y)=(284.92, 202.54), pin2 at (r6_x+5.08, r6_y)=(295.08, 202.54)

    # Wire from IN- junction down to R6 pin1
    fb_junct_x = u7_pin2_x + 2
    fb_junct_y = u7_pin2_y
    wires.append(make_wire(fb_junct_x, fb_junct_y, fb_junct_x, r6_y))
    wires.append(make_wire(fb_junct_x, r6_y, r6_x - 5.08, r6_y))
    junctions.append(make_junction(fb_junct_x, fb_junct_y))

    # Wire R6 pin2 → U7 OUT (via junction)
    wires.append(make_wire(r6_x + 5.08, r6_y, u7_pin6_x, r6_y))
    ...
    # R8 vertical: pin1 at (r8_x, r8_y-5.08), pin2 at (r8_x, r8_y+5.08)
    wires.append(make_wire(r8_x, r8_y - 5.08, r8_x, u7_pin3_y))
    ...
    wires.append(make_wire(r8_x, r8_y + 5.08, r8_x, r8_y + 8))
...
def generate_step6():
    ...
    # pin1 at (216.92, 265), pin2 at (227.08, 265)

    # Wire BNC signal → R9 pin1
    wires.append(make_wire(213.81, p2_y, 216.92, p2_y))
    ...
    node_in_x = 230
    node_in_y = p2_y
    wires.append(make_wire(227.08, p2_y, node_in_x, node_in_y))
    ...
    symbols.append(make_symbol("Custom:CA3140AMZ", "U8", "CA3140AMZ",
    ...
    wires.append(make_wire(r10_x, r10_y - 5.08, r10_x, c20_y))
    ...
    wires.append(make_wire(r10_x, r10_y + 5.08, r11_x, r11_y - 3.81))
    ...
    wires.append(make_wire(r11_x, r11_y + 3.81, r12_x, r12_y - 5.08))

    symbols.append(make_symbol("power:GND", "#PWR47", "GND",
                               r12_x, r12_y + 8, 0, pin_count=1))
    wires.append(make_wire(r12_x, r12_y + 5.08, r12_x, r12_y + 8))

    # ======== U9: TL081CDT (inverting amplifier) ========
    u9_x = 290
    u9_y = 190 + dy  # 260

    symbols.append(make_symbol("Custom:TL081CDT", "U9", "TL081CDT",
    ...
    wires.append(make_wire(out_node_x, r14_y, 264.92, r14_y))

    # Wire R14 pin2 → U9 IN-
    wires.append(make_wire(275.08, r14_y, u9_pin2_x, u9_pin2_y))
    ...
    # Wire from IN- junction down to R13 pin1
    fb_junct_x = u9_pin2_x + 2
    fb_junct_y = u9_pin2_y
    wires.append(make_wire(fb_junct_x, fb_junct_y, fb_junct_x, r13_y))
    wires.append(make_wire(fb_junct_x, r13_y, r13_x - 5.08, r13_y))
    junctions.append(make_junction(fb_junct_x, fb_junct_y))

    # Wire R13 pin2 → U9 OUT
    wires.append(make_wire(r13_x + 5.08, r13_y, u9_pin6_x, r13_y))
    ...
    wires.append(make_wire(r15_x, r15_y - 5.08, r15_x, u9_pin3_y))
    ...
    wires.append(make_wire(r15_x, r15_y + 5.08, r15_x, r15_y + 8))
...
def generate_step7():
    ...
    # pin1 at (r16_x, r16_y-5.08), pin2 at (r16_x, r16_y+5.08)
    wires.append(make_wire(r16_x, r16_y + 5.08, r16_x, sda_y))
    junctions.append(make_junction(r16_x, sda_y))
    symbols.append(make_symbol("power:+3V3", "#PWR57", "+3V3",
                               r16_x, r16_y - 8, 0, pin_count=1))
    wires.append(make_wire(r16_x, r16_y - 5.08, r16_x, r16_y - 8))
...
def generate_step8():
    ...
    wires.append(make_wire(r19_x, r19_y + 5.08, r19_x, io0_y))
    symbols.append(make_symbol("power:+3V3", "#PWR65", "+3V3",
                               r19_x, r19_y - 8, 0, pin_count=1))
    wires.append(make_wire(r19_x, r19_y - 5.08, r19_x, r19_y - 8))
...
# N-MOSFET lib symbol (IRLZ44NPBF TO-220)
...
# PC817 optocoupler lib symbol (DIP-4)
LIB_PC817 = """(symbol "Custom:PC817"
\t\t(pin_names (offset 1.016))
\t\t(exclude_from_sim no)
\t\t(in_bom yes)
\t\t(on_board yes)
...
def generate_step9():
    ...
    def mosfet_channel(q_ref, q_val, rg_ref, rpd_ref, d_ref,
        ...
        wires.append(make_wire(rg_x + 5.08, gate_y, gate_x, gate_y))
        labels.append(make_label(gate_label, rg_x - 5.08, gate_y, angle=180))
        ...
        wires.append(make_wire(rpd_x, rpd_y - 5.08, rpd_x, gate_y))
        ...
        wires.append(make_wire(rpd_x, rpd_y + 5.08, rpd_x, rpd_y + 8))

        # D: SS14 flyback
        d_x = drain_x + 7
        d_y = drain_y - 2
        symbols.append(make_symbol("Device:D", d_ref, "SS14",
                                   d_x, d_y, 0, pin_count=2))
    ...
    symbols.append(make_symbol("Custom:PC817", "U12", "PC817",
    ...
    wires.append(make_wire(r28_x + 5.08, opto_a_y, opto_a_x, opto_a_y))
    labels.append(make_label("RELAY_CTRL", r28_x - 5.08, opto_a_y, angle=180))
    ...
    wires.append(make_wire(r29_x, r29_y + 5.08, r29_x, opto_c_y))
    ...
    wires.append(make_wire(r29_x, r29_y - 5.08, r29_x, r29_y - 8))
    ...
    # D7 (1N4007) flyback across coil
    d7_x = coil_p_x - 7
    d7_y = rly_y
    symbols.append(make_symbol("Device:D", "D7", "1N4007",
                               d7_x, d7_y, 0, pin_count=2))
    ...
    wires.append(make_wire(r30_x, r30_y - 5.08, r30_x, com_y))
    ...
    wires.append(make_wire(r30_x, r30_y + 5.08, c29_x, c29_y - 3.81))
    ...
    # Pin 1: L_OUT
    labels.append(make_label("L_OUT", j11_x - 3.81 - 7, j11_y, angle=180))
    wires.append(make_wire(j11_x - 3.81 - 7, j11_y, j11_x - 3.81, j11_y))

    # Pin 2: N
    labels.append(make_label("AC_N", j11_x - 3.81 - 7, j11_y + 2.54, angle=180))
    wires.append(make_wire(j11_x - 3.81 - 7, j11_y + 2.54, j11_x - 3.81, j11_y + 2.54))

    # Pin 3: PE
    labels.append(make_label("PE", j11_x - 3.81 - 7, j11_y + 5.08, angle=180))
    wires.append(make_wire(j11_x - 3.81 - 7, j11_y + 5.08, j11_x - 3.81, j11_y + 5.08))
...
def generate_step10():
    ...
    for i, jref in enumerate(["J3", "J4", "J5", "J6"]):
        ...
        symbols.append(make_symbol("power:+3V3", f"#PWR{87+i*2}", "+3V3",
                                   jpx - 5, jy, 90, pin_count=1))
        wires.append(make_wire(jpx - 5, jy, jpx, jy))

        # Pin 2: ONEWIRE_DATA
        labels.append(make_label("ONEWIRE_DATA", jpx - 10, jy + 2.54, angle=180))
        wires.append(make_wire(jpx - 10, jy + 2.54, jpx, jy + 2.54))

        # Pin 3: GND
        symbols.append(make_symbol("power:GND", f"#PWR{88+i*2}", "GND",
                                   jpx - 5, jy + 5.08, 90, pin_count=1))
        wires.append(make_wire(jpx - 5, jy + 5.08, jpx, jy + 5.08))
    ...
    wires.append(make_wire(r31_x, r31_y + 5.08, r31_x, r31_y + 8))
