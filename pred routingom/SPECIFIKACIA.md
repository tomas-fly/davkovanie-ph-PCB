...
| D8 | PESD5V0S1BA | TVS dióda | SOD-323 | ESD ochrana BNC vstupu |
...
| R8 | Rezistor | 75kΩ | 0805 | Offset kalibrácia — pripojený na R4 wiper cez net pH_CAL |
...
| D9 | PESD5V0S1BA | TVS dióda | SOD-323 | ESD ochrana BNC vstupu |
...
| R15 | Rezistor | 75kΩ | 0805 | Offset kalibrácia — pripojený na R11 wiper cez net ORP_CAL |
...
| AIN2 | voľný (NC) | — |
| AIN3 | GND | Diferenciálna referencia |

**Režim merania:** Diferenciálny (nie single-ended!)
- pH: AIN0–AIN3, PGA ±0.512V (rozlíšenie 15.6µV/bit)
- ORP: AIN1–AIN3, PGA ±2.048V (rozlíšenie 62.5µV/bit)
- Diferenciálny režim umožňuje merať záporné napätia z pH/ORP sond
...
|-----|-------|---------------|
| J13 | Q1: Čerpadlo NKP-DCL-B10D (12V/5W) | Šróbovacia svorkovnica 2-pin (+12V + drain) |
| — | Q2: Relé cievka | Interný vodič (drain → cievka RLY1) |
...
- D4 (SS14): Flyback dióda na Q2 drain (chráni MOSFET aj cievku RLY1)
...
| 16 | D8, D9 | PESD5V0S1BA | TVS bidirekt. | 2 | SOD-323, ESD ochrana BNC |
...
| 58 | J9, J10, J13 | Šróbovacia svorkovnica 2-pin | 5mm pitch | 3 | MOSFET výstupy Q3, Q4 + pumpa Q1 |
...
| Varistor (MOV1) | 1 |
| Poistka (F1) | 1 |
| Konektory (J1-J13, P1-P2) | 15 |
| **Celkom** | **~105 súčiastok** |
...
| 15 | D8, D9 | PESD5V0S1BA | [TME](https://www.tme.eu/en/details/pesd5v0s1ba.115/esd-protection-diodes/nexperia/) | **SOD-323** | TVS ESD ochrana BNC, bidirekt., 5V clamp |
...
- **D8, D9 (PESD5V0S1BA):** TVS ESD ochrana na BNC vstupoch. SOD-323 puzdro, Nexperia. Clamp na ±5V, chráni CA3140 vstupy.
...
| PESD5V0S1BA (TVS) | 2 | D8-D9 | SOD-323 |
...
| Šróbovacia svorkovnica 2-pin | 3 | J9, J10, J13 | 5.0mm (alebo 5.08mm) | MOSFET výstupy Q1 (pumpa), Q3, Q4 |
...
- Čerpadlo NKP-DCL-B10D je v boxe, pripojené na J13 (2-pin svorkovnica)
- ORP front-end je rovnaký ako pH, len iná sonda a kalibrácia
- D4 (SS14 na Q2 drain) slúži aj ako flyback dióda pre cievku RLY1 — samostatná D7 nie je potrebná
- D8, D9 (PESD5V0S1BA) — bidirektionálna TVS ESD ochrana na BNC vstupoch pH/ORP sond
- R4/R11 trimpoťáky — wiper pripojený cez R8/R15 na TL071 IN+ pre hardwarovú kalibráciu offsetu
- ADS1115 pracuje v diferenciálnom režime (AIN0-AIN3, AIN1-AIN3) — umožňuje merať záporné napätia z pH/ORP sond
