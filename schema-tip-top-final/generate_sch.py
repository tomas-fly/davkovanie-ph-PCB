...
_FP_DEFAULTS = {
    ...
    "Device:D_TVS":            "Diode_SMD:D_SOD-323",
    ...
    "Custom:CA3140EZ":         "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm",
    "Custom:TL071IP":          "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm",
...
LIB_D_TVS = """(symbol "Device:D_TVS" (pin_numbers (hide yes)) (pin_names (offset 1.016) (hide yes))
    (exclude_from_sim no) (in_bom yes) (on_board yes)
    (property "Reference" "D" (at 0 2.54 0)
      (effects (font (size 1.27 1.27)))
    )
    ...
    (property "Description" "Bidirectional TVS diode" (at 0 0 0)
      (effects (font (size 1.27 1.27)) (hide yes))
    )
    (symbol "D_TVS_0_1"
      (polyline
...
def generate_step1():
    ...
    # PE label — already placed above with J1 connector labels
    ...
    # J12: 12V screw terminal — external 12V input/output
    # Conn_01x02 at (125, 80): pin1 at (125-3.81, 80+2.54), pin2 at (125-3.81, 80-2.54)
    # Wait — Conn_01x02 pin1 at (-3.81, 0), pin2 at (-3.81, -2.54) in lib? Let me use same as other connectors.
    # Conn_01x02 pins: pin1 at (j_x - 3.81, j_y), pin2 at (j_x - 3.81, j_y + 2.54)
    j12_x = 130
    j12_y = 65
    symbols.append(make_symbol("Connector_Generic:Conn_01x02", "J12", "12V_IO",
...
def generate_step5():
    ...
    # ======== D8: TVS ESD protection on BNC signal ========
    d8_x = 215
    d8_y = p1_y + 7
    lib_symbols.append(LIB_D_TVS)
    symbols.append(make_symbol("Device:D_TVS", "D8", "PESD5V0S1BA",
                               d8_x, d8_y, 90, pin_count=2))
    # D_TVS at 90°: pin1 at (d8_x, d8_y-3.81), pin2 at (d8_x, d8_y+3.81)
    ...
    # R8 (75kΩ) from IN+ to pH_CAL (offset calibration via R4 wiper)
    r8_x = u7_pin3_x - 5
    r8_y = u7_pin3_y
...
def generate_step6():
    ...
    # ======== D9: TVS ESD protection on BNC signal ========
    d9_x = 215
    d9_y = p2_y + 7
    symbols.append(make_symbol("Device:D_TVS", "D9", "PESD5V0S1BA",
    ...
    # R15 (75kΩ) from IN+ to ORP_CAL (offset calibration via R11 wiper)
    r15_x = u9_pin3_x - 5
    r15_y = u9_pin3_y
...
def generate_step9():
    ...
    # ================================================================
    # Q1: Pump (MOSFET1_GATE, GPIO33) + J13
    # ================================================================
    q1_x, q1_y = 40, 370
    ...
    j13_x = q1_drain_x + 15
    j13_y = q1_drain_y
    symbols.append(make_symbol("Connector_Generic:Conn_01x02", "J13", "PUMP",
                               j13_x, j13_y, 0, pin_count=2))
    # +12V above pin 1 (vertical, not on flyback wire)
    symbols.append(make_symbol("power:+12V", "#PWR69", "+12V",
                               j13_x - 3.81, j13_y - 5, 0, pin_count=1))
    wires.append(make_wire(j13_x - 3.81, j13_y - 5, j13_x - 3.81, j13_y))
    # Pin 2 → Q1 drain
    wires.append(make_wire(j13_x - 3.81, j13_y + 2.54, q1_drain_x, j13_y + 2.54))
    wires.append(make_wire(q1_drain_x, q1_drain_y, q1_drain_x, j13_y + 2.54))
    junctions.append(make_junction(q1_drain_x, q1_drain_y))
    ...
    # D4 (SS14 from mosfet_channel) already provides flyback protection
    # across the same nets (+12V ↔ Q2 drain), so no extra diode needed here
    ...
    symbols.append(make_symbol("power:+12V", "#PWR80", "+12V",
                               j9_x - 3.81, j9_y - 5, 0, pin_count=1))
    wires.append(make_wire(j9_x - 3.81, j9_y - 5, j9_x - 3.81, j9_y))
    ...
    symbols.append(make_symbol("power:+12V", "#PWR84", "+12V",
                               j10_x - 3.81, j10_y - 5, 0, pin_count=1))
    wires.append(make_wire(j10_x - 3.81, j10_y - 5, j10_x - 3.81, j10_y))
