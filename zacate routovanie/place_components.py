...
P = {
    ...
    # ══════════════════════════════════════════════
    # MODULE 5: ESP32 (center, below power)
    # ESP32-WROOM-32E footprint:
    #   Origin at bottom-center of pads
    #   Body extends ~25mm UP (negative Y in KiCad)
    #   Courtyard: x±12mm, y: -28..+2 from origin
    #   Antenna keep-out: extends ~5mm beyond body top and sides
    #   TOTAL keep-out: ~30x35mm centered above origin
    # At origin (92,118): keep-out spans x=78..106, y=83..120
    # ALL components must be OUTSIDE this zone!
    # ══════════════════════════════════════════════
    "U11":  (92, 118),      # ESP32 origin at bottom of pads
    # Support components BELOW ESP32 (y > 120)
    "C27":  (82, 124),      # bypass caps
    "C28":  (88, 124),
    "C26":  (94, 124),
    "R18":  (100, 124),
    # Support components FAR LEFT of ESP32 (x < 76)
    "R19":  (72, 90),       # pull resistors
    "R16":  (72, 96),
    "R17":  (72, 102),
    # UART header below-right
    "J8":   (112, 118),
    # ADS1115 ADC (right of ESP32 keep-out, x > 108)
    "U10":  (118, 96),      # MSOP-10
    "C25":  (118, 90),
    "R31":  (126, 96),
    ...
    # ══════════════════════════════════════════════
    # MODULE 9: MOSFET Outputs & Relay (bottom, shifted down)
    # ══════════════════════════════════════════════
    "Q1":   (80, 134),      # TO-252 MOSFETs
    "Q2":   (94, 134),
    "Q3":   (108, 134),
    "Q4":   (122, 134),
    "R20":  (78, 142),      # gate/pulldown resistors
    "R21":  (82, 142),
    "R22":  (92, 142),
    "R23":  (96, 142),
    "R24":  (106, 142),
    ...
    "R29":  (136, 142),
    "R30":  (142, 142),
    "D3":   (80, 148),      # flyback diodes
    "D4":   (94, 148),
    "D5":   (108, 148),
    "D6":   (122, 148),
    "D7":   (134, 148),
    "J9":   (80, 155),      # output terminals
    "J10":  (98, 155),
    "J11":  (118, 155),     # AC output 3-pin
    "RLY1": (148, 148),     # Finder relay 30x13mm
    "U12":  (136, 134),     # optocoupler SOP-4
}
